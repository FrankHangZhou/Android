...
System.out.println("来源自：http://blog.csdn.net/liyan622/article/details/5996401  利用它算密钥--author@frank");

String masterKey = "00000000000000000000000000000000";//原始密钥
//数据
String data = "3030303080000000";

String des_3=DES_3(data, masterKey, 0);//会话密钥

System.out.println("第1步骤：得到会话密钥"+des_3);

System.out.println("第2步：用会话密钥进行DES加密");
System.out.println("我们循环三次");
/*
 *
 *单DES ==会话密钥+密钥明文进行DES
 *密钥明文：14+01010182+11223344556677881122334455667788+800000
 */
String k="14"+"01010182"+"11223344556677881122334455667788";
...
System.out.println("K长度： "+k);


int count=k.trim().length()/16;
String a[]=new String[3];
String Fdes_1="";
for(int i=0;i<count;i++){

	a[i]=DES_1(k.substring(i*16, ((i+1)*k.trim().length())/count),des_3,0);
	System.out.println("a： "+a[i]+" i: "+a[i].trim().length());
	Fdes_1=Fdes_1+a[i];
}

System.out.println("最终："+Fdes_1);

//参与计算MAC的报文
String DesMac="84D400001C"+Fdes_1;


//计算MAC
System.out.println("第3步：计算MAC");
String MAC=MAC(des_3, null, DesMac, 0);
System.out.println("最终MAC："+MAC);
