        ...
        if (whitelist != null) {
	        for (String macAddress : whitelist.get()) {
	        	...
	        	if (leases.containsKey(macAddress)) {
	            	...
	            	Log.d(TAG, clientData.isConnected()+" - "+clientData.getIpAddress());
