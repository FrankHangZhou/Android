...
public class MaskSurfaceView extends SurfaceView implements
	...
	public void surfaceCreated(SurfaceHolder holder) {
		mode = new Random().nextInt(2); // 随机�?��[0-2)�?
		new Thread(this).start(); // �?��绘制
	}
	...
	private void drawMask() {
		...
		if (0 == mode) {
			drawHeart2D(mCanvas, mPaint, w / 2, h / 2, h / 2); // 画一�?d爱心
		} else {
			drawHeart3D(mCanvas, mPaint); // 画一�?d爱心
		}
